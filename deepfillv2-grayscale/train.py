...
if __name__ == "__main__":
    ...
    # General parameters
    parser.add_argument(
        "--pre_train", type=bool, default=True, help="the type of GAN for training"
    )
    parser.add_argument(
        "--save_path", type=str, default="./models", help="saving path that is a folder"
    )
    parser.add_argument(
        "--sample_path",
        type=str,
    ...
    parser.add_argument(
        "--finetune_path", type=str, default="", help="the load name of models"
    )
    # Training parameters
    parser.add_argument(
        "--epochs", type=int, default=101, help="number of epochs of training"
    )
    ...
    parser.add_argument(
        "--lambda_l1", type=float, default=10, help="the parameter of L1Loss"
    )
    parser.add_argument(
        "--lambda_perceptual",
        type=float,
    ...
    parser.add_argument(
        "--lambda_gan", type=float, default=0.1, help="the parameter of GAN loss"
    )
    parser.add_argument(
        "--num_workers",
        type=int,
    ...
    parser.add_argument(
        "--latent_channels", type=int, default=64, help="latent channels"
    )
    parser.add_argument("--pad", type=str, default="reflect", help="the padding type")
    parser.add_argument(
        "--activ_g", type=str, default="lrelu", help="the activation type"
    )
    parser.add_argument(
        "--activ_d", type=str, default="lrelu", help="the activation type"
    )
    ...
    parser.add_argument(
        "--init_type", type=str, default="normal", help="the initialization type"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--bbox_shape", type=int, default=30, help="margin of image for bbox mask"
    )
    parser.add_argument(
        "--max_angle", type=int, default=4, help="parameter of angle for free form mask"
    )
    parser.add_argument(
        "--max_len", type=int, default=40, help="parameter of length for free form mask"
    )
    parser.add_argument(
        "--max_width", type=int, default=2, help="parameter of width for free form mask"
    )
